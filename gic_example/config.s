...
config_gic:
              ...
              ldr r0, =MPCORE_GIC_CPUIF // GIC CPU interface base addres
...
config_interrupt:
              ...
              /* compute reg_offset */
              ldr r2, =MPCORE_GIC_DIST+ICDISER // base address of set-enable registers (ICDISER)
               ...
               *   value = id % 32                                       */
               ...
               ldr  r2, =MPCORE_GIC_DIST+ICDIPTR // base address of processor target registers 
